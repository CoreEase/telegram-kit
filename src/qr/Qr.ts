import { encodeQrMatrix } from '../_internal/qr/encoder';
import type { QrEncodeOptions, QrEncodeResult } from '../_internal/qr/types';
import type { ErrorCorrectionLevel } from '../_internal/qr/tables';
